...
class Real_Time_Spectra(object):
    ...
    def sum_graph(self, data):
        ...
        ax3.set_axis_off()
        if display <= 150:
            ax3.text(0.1, 1.5,"Counts: "+ str(display), fontsize = 14 , ha = "center", backgroundcolor = "lightgreen")
            ax3.text(0.7, 1.5,"Dose: "+ dose_display, fontsize = 14, ha = "center", backgroundcolor = "lightgreen")

        elif display > 150 and display <= 500:
            ax3.text(0.1, 1.5,"Counts: "+str(display), fontsize = 14, ha = "center", backgroundcolor = "yellow")
            ax3.text(0.7, 1.5,"Dose: "+dose_display, fontsize = 14, ha = "center" , backgroundcolor = "yellow")


        elif display > 500 and display <= 2000:
            ax3.text(0.1, 1.5,"Counts: "+str(display), fontsize = 14, ha = "center", backgroundcolor = "orange")
            ax3.text(0.7, 1.5,"Dose: "+dose_display, fontsize = 14, ha = "center",  backgroundcolor = "orange")


        elif display > 2000:
            ax3.text(0.2, 1.5,"Counts: "+str(display), fontsize = 14, ha = "center" , backgroundcolor = "red")
            ax3.text(0.7, 1.5,"Dose: "+dose_display, fontsize = 14, ha = "center", backgroundcolor = "red")
