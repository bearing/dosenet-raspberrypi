        ...
        try:
            if not CO2_port:
                if self.small_board:
                    ...
                    self.CO2_port = Adafruit_MCP3008.MCP3008(clk=CO2_pins[1][0], cs=CO2_pins[1][1], miso=CO2_pins[1][2], mosi=CO2_pins[1][3], gpio=GPIO.RPiGPIOAdapter(GPIO,mode=GPIO.BCM))
                else:
