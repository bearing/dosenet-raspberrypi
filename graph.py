...
fig1 = plt.figure(1)
fig1.plot(middletime_final, new_P3, "b.", label='P3')
fig1.plot(middletime_final, new_P5, "g.", label = 'P5')
fig1.plot(middletime_final, new_P10, "r.", label = 'P10')
fig1.plot(middletime_final, new_P25, "m.", label = 'P25')
fig1.plot(middletime_final, new_P50, "y.", label = 'P50')
fig1.plot(middletime_final, new_P100, "c.", label = 'P100')
fig1.legend(loc="best")
fig1.xlabel("Time")
fig1.ylabel("Particle Count")
...
fig1.title(file_title)
fig1.add_axes([.5,.3,.35,.15])
