...
f = plt.plot
f(middletime_final, new_P3, "b.", label='P3')
f(middletime_final, new_P5, "g.", label = 'P5')
f(middletime_final, new_P10, "r.", label = 'P10')
f(middletime_final, new_P25, "m.", label = 'P25')
f(middletime_final, new_P50, "y.", label = 'P50')
f(middletime_final, new_P100, "c.", label = 'P100')
plt.legend(loc="best")
plt.xlabel("Time")
...
g = plt.plot
g(middletime_final, new_Val10, "b.", label='1.0')
g(middletime_final, new_Val25, "g.", label = '2.5')
g(middletime_final, new_Val100, "r.", label = '10')
plt.legend(loc="best")
plt.xlabel("Time")
