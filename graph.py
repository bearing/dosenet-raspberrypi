...
fig1 = fig.plot(1)
fig1.add_subplot(num=None, figsize=(10, 12), dpi=80, facecolor='w', edgecolor='k')
axe = fig1.add_axes([.5,.3,.35,.15])
axe.plot(middletime_final, new_P3, "b.", label='P3')
axe.plot(middletime_final, new_P5, "g.", label = 'P5')
axe.plot(middletime_final, new_P10, "r.", label = 'P10')
axe.plot(middletime_final, new_P25, "m.", label = 'P25')
axe.plot(middletime_final, new_P50, "y.", label = 'P50')
axe.plot(middletime_final, new_P100, "c.", label = 'P100')
axe.legend(loc="best", title = "Key")
plt.xlabel("Time")
...
fig2 = fig.plot(2)
fig2.add_subplot(num=None, figsize=(10, 12), dpi=80, facecolor='w', edgecolor='k')
...
axe2.legend(loc="best", title = "Key")
plt.xlabel("Time")
