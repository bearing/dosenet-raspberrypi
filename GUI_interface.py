...
def make_run_gui():
    ...
    def press(): 
        ...
        check_plots(0)
        wdaq.press()
        plot_jobs[0]=top.after(int(n_merge.get())*1000,press)
    ...
    def temp():
        ...
        check_plots(1)
        wdaq.temp()
        plot_jobs[1]=top.after(int(n_merge.get())*1000,temp)
    ...
    def humid():
        ...
        check_plots(2)
        wdaq.humid()
        plot_jobs[2]=top.after(int(n_merge.get())*1000,humid)
    ...
    def CO2():
        ...
        check_plots(3)
        adcdaq.plot_CO2()
        plot_jobs[3]=top.after(int(n_merge.get())*1000,CO2)
    ...
    def airquality():
        ...
        check_plots(4)
        aqdaq.pmplot()
        plot_jobs[4]=top.after(int(n_merge.get())*1000,airquality)
    ...
    def D3S_spectra():
        ...
        plot_jobs[5]=top.after(int(n_merge.get())*1000,D3S_spectra)
    ...
    def D3S_waterfall():
        ...
        plot_jobs[6]=top.after(int(n_merge.get())*1000,D3S_waterfall)
