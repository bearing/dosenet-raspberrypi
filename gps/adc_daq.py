...
class adc_DAQ(object):
    ...
    def send_data(self, data):
		...
		channel.queue_declare(queue='toGUI_CO2')
		message = {'id': 'CO2', 'data': data}

		channel.basic_publish(exchange='',
							  routing_key='toGUI_CO2',
    ...
    def receive(self):
        ...
        channel = connection.channel()
        channel.queue_declare(queue='fromGUI_CO2')
        method_frame, header_frame, body = channel.basic_get(queue='fromGUI_CO2')
        if body is not None:
