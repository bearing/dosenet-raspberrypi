...
class air_quality_DAQ():
	...
	def send_data(self, data):
		...
		channel.queue_declare(queue='toGUI_aq')
		message = {'id': 'Air Quality', 'data': data}

		channel.basic_publish(exchange='',
							  routing_key='toGUI_aq',
	...
	def receive(self):
		...
		channel = connection.channel()
		channel.queue_declare(queue='fromGUI_aq')
		method_frame, header_frame, body = channel.basic_get(queue='fromGUI_aq')
		if body is not None:
